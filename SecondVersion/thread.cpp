...
Thread::Thread(ThreadFunc func)
	: m_func(func), m_threadId(m_generateId++)
{
}
...
ThreadPool::ThreadPool()
	: m_initThreadSize(0), m_taskSize(0), m_idleThreadSize(0), m_curThreadSize(0), m_taskqueMaxThresHold(TASK_MAX_THRESHHOLD), m_threadSizeThreshHold(THREAD_MAX_THRESHHOLD), m_poolMode(PoolMode::MODE_FIXED), m_isPoolRunning(false)
{
}
